...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between bg-white p-6 rounded-lg border border-libborder shadow-sm">
        <div>
            <h2 class="text-base font-bold text-libnavy">Tambah Buku</h2>
            <p class="text-xs text-libmuted mt-1">Daftarkan koleksi buku baru untuk pustaka perpustakaan.</p>
        </div>
        ...
        <form action="{{ route('books.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="book_code" id="book_code" value="{{ old('book_code', $nextCode) }}" required
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                    ...
                    placeholder="Sinopsis singkat atau info tambahan buku..."></textarea>
                @error('description')
                    <p class="text-xs text-libdanger mt-1.5 font-medium">{{ $message }}</p>
                @enderror
            </div>
