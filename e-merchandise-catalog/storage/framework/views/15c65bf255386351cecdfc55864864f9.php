    ...
    <div class="card">
        <div class="card-body" style="text-align: center;">
            ...
            <p style="margin-top: 2rem; color: #666;">
                Admin/Panitia? <a href="<?php echo e(route('admin.login')); ?>" style="color: var(--primary);">Login disini</a>
            </p>
        </div>
    </div>
</div>
...
<script>
    ...
    async function verifyOtp() {
        ...
        const response = await fetch('<?php echo e(route('verify.otp')); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\Freelance Projects\merch\resources\views/auth/login.blade.php ENDPATH**/ ?>