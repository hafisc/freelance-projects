    ...
    <div class="max-w-3xl mx-auto">
        <div class="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/60 shadow-sm space-y-6">
            ...
            <div class="flex items-center justify-between pb-5 border-b border-slate-100">
                <div>
                    <h3 class="text-xl font-extrabold text-slate-800 tracking-tight">Form Tugas Baru</h3>
                    <p class="text-xs font-medium text-slate-400 mt-1">Lengkapi detail informasi tugas di bawah ini secara lengkap.</p>
                </div>
            ...
            <!-- Form Proses Submit ke route tasks.store -->
            <form action="{{ route('tasks.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="title" id="title" value="{{ old('title') }}" required placeholder="Ketik judul tugas Anda..." 
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="category" id="category" value="{{ old('category') }}" placeholder="Contoh: Kuliah, Kerja, Pribadi, Organisasi" 
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select name="status" id="status" 
                                ...
                                <option value="belum_dikerjakan" {{ old('status', 'belum_dikerjakan') === 'belum_dikerjakan' ? 'selected' : '' }}>Belum Dikerjakan</option>
