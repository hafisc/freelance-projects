...
class UpdateBookRequest extends FormRequest
{
    ...
    /**
     * Aturan validasi untuk memperbarui data buku.
     */
    public function rules(): array
    {
        ...
        return [
            'book_code' => ['required', 'string', 'max:50', 'unique:books,book_code,' . $bookId],
    ...
    public function messages(): array
    {
        return [
            ...
            'book_code.unique' => 'Kode buku sudah digunakan oleh buku lain.',
