...
class UpdateJurusanRequest extends FormRequest
{
    ...
    {
        // Izinkan semua admin yang terautentikasi untuk memperbarui data
        return true;
    }
    ...
    {
        // Mengambil ID jurusan dari parameter rute untuk pengecualian validasi unik
        $jurusan = $this->route('jurusan');
        $jurusanId = is_object($jurusan) ? $jurusan->id : $jurusan;

        return [
            'nama_jurusan' => ['required', 'string', 'max:100', 'unique:jurusans,nama_jurusan,' . $jurusanId],
