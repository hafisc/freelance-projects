            ...
            <div class="custom-card-body">
                ...
                <form action="{{ route('jurusan.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control @error('keterangan') is-invalid @enderror" id="keterangan" name="keterangan" rows="4" placeholder="Tuliskan keterangan singkat mengenai jurusan ini...">{{ old('keterangan') }}</textarea>
                        @error('keterangan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
