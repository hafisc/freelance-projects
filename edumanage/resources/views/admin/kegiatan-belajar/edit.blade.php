...
<div class="content-header">
    <div class="content-title">Edit Kegiatan Belajar</div>
...
<div class="card" style="max-width: 700px; margin: 0 auto;">
    <div class="card-header">
        <div class="card-title">Form Edit Jurnal Kegiatan</div>
    </div>
    
    <div class="card-body">
        <form action="{{ route('kegiatan-belajar.update', $kegiatan->id) }}" method="POST">
            @csrf
            @method('PUT')
