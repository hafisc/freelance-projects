...
<div class="content-header">
    <div class="content-title">Edit User</div>
...
<div class="card" style="max-width: 600px; margin: 0 auto;">
    <div class="card-header">
        <div class="card-title">Form Edit User: {{ $user->name }}</div>
    </div>
    ...
    <div class="card-body">
        <form action="{{ route('users.update', $user->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror" placeholder="Biarkan kosong jika tidak ingin diubah">
                <small class="text-muted" style="display: block; margin-top: 4px;">Isi hanya jika ingin memperbarui kata sandi akun.</small>
                @error('password')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
